...
def _docgen_toolchain_impl(ctx):
...
docgen_toolchain = rule(
    implementation = _docgen_toolchain_impl,
    attrs = {
    ...
    doc = """Defines a docgen compiler/runtime toolchain.
