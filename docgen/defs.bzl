...
load("//docgen/private:markdown_action.bzl", _markdown_action = "markdown_action", _markdown_action_impl = "markdown_action_impl")
...
markdown_action_impl = _markdown_action_impl
