...
# By default all these toolchains are registered by the docgen_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:docgen_toolchain",
    toolchain_type = "@jacobshirley_rules_docgen//docgen:toolchain_type",
)
""".format(
            platform = platform,
