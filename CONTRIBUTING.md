...
some other ruleset that depends on rules_docgen, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_docgen=$(pwd)/rules_docgen"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_docgen` on your system will point to this folder.
...
https://github.com/jacobshirley/rules_docgen/actions/workflows/tag.yaml
